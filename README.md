...
- 🎯 Entry points to execute your program using `python -m <yoloraft>` or `$ yoloraft` with basic CLI argument parsing.
...
Awesome yoloraft created by arunma
...
```py
from yoloraft import BaseClass
from yoloraft import base_function
